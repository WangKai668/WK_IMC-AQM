...
if __name__ == "__main__":
	...
	print("nhost: %d, load: %f, bandwidth: %f, time: %f"%(nhost, load, bandwidth, time))
	...
	if output == default_output:
		...
		output = output_prefix+"traffic_%s_n%d_l%f_b%g_t%ds.txt"%(cdf_name, nhost, load, bandwidth, time/1e9)
	ofile = open(output, "w")
