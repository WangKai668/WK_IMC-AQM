...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
#define RED_CC_MOD 1
#define CoDel_CC_MOD 2
#define MATCP_CC_MOD 3
#define CEDM_CC_MOD 4
#define MBECN_CC_MOD 5
#define PRED_CC_MOD 6
#define IMCAQM_CC_MOD 7
...
int main(int argc, char *argv[])
{
	...
	begint = clock();
	std::ifstream conf;
	bool wien = false; // wien enables PowerTCP.  //不启动powertcp！！！
	...
	uint32_t algorithm = 3;//算法
	uint32_t windowCheck = 1;

	///////////////////////////////////////////////////////////////////////////////////////////////////////////
	//修改config-workload，改成config-RED
	///////////////////////////////////////////////////////////////////////////////////////////////////////////
	// std::string confFile = "/home/vamsi/src/phd/codebase/ns3-datacenter/simulator/ns-3.39/examples/PRED/config-RED.txt";
	// std::string cdfFileName = "/home/vamsi/src/phd/codebase/ns3-datacenter/simulator/ns-3.39/examples/PRED/websearch.txt";
	std::string confFile = "/home/wk/Reverie-Platform/ns3-datacenter/simulator/ns-3.39/examples/PRED/config-RED.txt";
	std::string cdfFileName = "/home/wk/Reverie-Platform/ns3-datacenter/simulator/ns-3.39/examples/PRED/websearch.txt";
...
//YRNK_ADD：PRED相关参数设置
	...
	while (!conf.eof())
	{
		...
		// } 
			...
			}else if (key.compare("CDF_FILE") == 0){//采用cdf进行仿真
				conf >> cdfFileName;
				std::cout << "POINT_SLOPE_LAMBDA\t\t\t\t" << cdfFileName << '\n';
			}/*YRNK_ADD_END*/
		fflush(stdout);
	}
	conf.close();//配置加载完毕，关闭文件输入流！！！

	// overriding config file. I prefer to use cmd arguments
	cc_mode = algorithm; // overrides configuration file//通过cmd复写conf的算法配置
	...
	/////////////////////////////////////////////////////////////////////////////////////////////
	// IntHeader::mode cc_mod，即algorithm的选择，算法这一块！！！
	// CC_MODE！！！ 所在之处
	/////////////////////////////////////////////////////////////////////////////////////////////
	...
	for (uint32_t i = 0; i < node_num; i++) {
		if (n.Get(i)->GetNodeType()) { // is switch
			Ptr<SwitchNode> sw = DynamicCast<SwitchNode>(n.Get(i));//sw所在之处！！！即为switchnode
